    ...
    <div class="row mt-4">
        ...
        <div class="col-md-3 mb-3">
            <div class="card bg-warning text-dark shadow">
                <div class="card-body">
                    <h5 class="card-title"><i class="bi bi-receipt"></i> Fact. Ptes</h5>
                    <h2 class="display-4"><?= $stats['pending_sales'] ?></h2>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-3">
            <a href="index.php?page=admin_fleet" class="text-decoration-none">
                <div class="card bg-info text-dark shadow">
                    <div class="card-body">
                        <h5 class="card-title"><i class="bi bi-truck"></i> Vehículos</h5>
                        <h2 class="display-4"><?= $stats['vehicles'] ?></h2>
                    </div>
                </div>
            </a>
        </div>
